import logging
from components.common import split_data, features, remove_first_k_gameweeks
...
match_data_df = "./csv/final_match_data.csv"
...
# Update (RecentPPG, AvgShots/SOT): Best k: 5, Log Loss: 0.9993317628384265, Accuracy: 0.5253787878787879
# Update (XG): 
...
# Update (RecentPPG, AvgShots/SOT): Best k: 7, Log Loss: 1.2439276466838884, Accuracy: 0.494758064516129
# Update (XG): 
